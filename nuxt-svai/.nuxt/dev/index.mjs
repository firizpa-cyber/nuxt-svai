...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getRequestProtocol, getRequestHost, setHeader, getQuery as getQuery$1, getHeader, readBody, getResponseStatus, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getResponseStatusText } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { promises, existsSync, readFileSync, writeFileSync } from 'node:fs';
import { z } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/zod/index.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, withoutTrailingSlash, withTrailingSlash, decodePath, withLeadingSlash, withBase, parsePath, stringifyQuery, parseQuery, encodePath, stringifyParsedURL, joinRelativeURL } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/defu/dist/defu.mjs';
import destr, { destr as destr$1 } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/devalue/index.js';
import { toValue, isVNode, isRef } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/unstorage/drivers/fs.mjs';
import file_58_47_47_47D_58_47_37D0_37B2_37D0_37BC_47project_4503b78a3c_47nuxt_45svai_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js';
import { digest, hash as hash$1 } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { createConsola, consola as consola$1 } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/youch-core/build/index.js';
import { Youch } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/source-map/source-map.js';
import devalue from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/errx/dist/index.js';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$2, isAbsolute } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/pathe/dist/index.mjs';
import { createFilter } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/nuxtseo-shared/dist/utils.mjs';
import { walkResolver } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/unhead/dist/utils.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"D:/вм/project-03b78a3c/nuxt-svai/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/вм/project-03b78a3c/nuxt-svai","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/вм/project-03b78a3c/nuxt-svai/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', file_58_47_47_47D_58_47_37D0_37B2_37D0_37BC_47project_4503b78a3c_47nuxt_45svai_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"file:///D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"D:/вм/project-03b78a3c/nuxt-svai/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/вм/project-03b78a3c/nuxt-svai/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/вм/project-03b78a3c/nuxt-svai/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:/вм/project-03b78a3c/nuxt-svai/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "nuxt-robots": {
      ...
      "sitemap": [
        "https://surgutsvai.ru/sitemap.xml",
        "/sitemap.xml"
      ],
      "header": true,
  ...
  "smtpPort": "465",
  "smtpUser": "surgutsvai43@gmail.com",
  "smtpPass": "npgwqfrazvcktopf",
  "senderEmail": "surgutsvai43@gmail.com",
  "recipientEmail": "surgutsvai43@gmail.com",
  "sitemap": {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "D:/вм/project-03b78a3c/nuxt-svai/public"
      ]
    },
    "http": {
      "domains": []
...
const _ktWjTPj_4OR4RIMsOXpuAn31sal_l4y5k2cuzHe5Vs = (function(nitro) {
...
const _ouUE_zX1soY5egyX7FIgZlaqNTz3DhgoS7buHhUivBI = defineNitroPlugin(async (nitroApp) => {
...
const _Ufd3L56EalAqITzArb49A161ZVay2IXsbbXTOGSc2jE = defineNitroPlugin(async (nitroApp) => {
...
const _BSLYNZEJbZDGczi1lKy1QnM2DFFsdsuNLYTET4G16s = (nitroApp) => {
...
const plugins = [
  _ktWjTPj_4OR4RIMsOXpuAn31sal_l4y5k2cuzHe5Vs,
_ouUE_zX1soY5egyX7FIgZlaqNTz3DhgoS7buHhUivBI,
_Ufd3L56EalAqITzArb49A161ZVay2IXsbbXTOGSc2jE,
_BSLYNZEJbZDGczi1lKy1QnM2DFFsdsuNLYTET4G16s,
...
const assets = {
  "/index.mjs": {
    ...
    "etag": "\"3ea7f-Y5tt/89dUcXc45uiWxheVK8MK2Y\"",
    "mtime": "2026-06-08T09:43:14.786Z",
    "size": 256639,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"ffd57-D7GDZyHx+tmeOUamz3227PVHWMI\"",
    "mtime": "2026-06-08T09:43:14.793Z",
    "size": 1047895,
    "path": "index.mjs.map"
  }
};
...
const _1FoeKh = eventHandler((event) => {
...
const _th4mdk = eventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
...
const _cuTWqx = eventHandler(async (e) => {
...
async function parseSitemapIndex(xml) {
  ...
  const { XMLParser } = await import('file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/fast-xml-parser/src/fxp.js');
...
const _jV639t = defineEventHandler(async (e) => {
...
const _k9w9bu = defineEventHandler(async (e) => {
...
const _U19pTR = defineEventHandler(async (e) => {
...
const _8gwhEF = defineEventHandler(sitemapXmlEventHandler);

const _LwPWF3 = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _RPWm18 = defineEventHandler(async (e) => {
...
const _AHeKSI = defineEventHandler(async (e) => {
...
const _2FBAX3 = defineEventHandler(async (e) => {
  const query = getQuery$1(e);
...
const _ZK6vBL = defineEventHandler(async (e) => {
  const { url, mode } = getQuery$1(e);
  if (!url || typeof url !== "string")
...
const __WInkx = lazyEventHandler(() => {
...
const _lazy__5tucD = () => Promise.resolve().then(function () { return orders_get$1; });
const _lazy_qPuHZc = () => Promise.resolve().then(function () { return orders_post$1; });
const _lazy_UDkCEj = () => Promise.resolve().then(function () { return products_get$1; });
const _lazy_y3aAom = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _1FoeKh, lazy: false, middleware: true, method: undefined },
  { route: '/api/orders', handler: _lazy__5tucD, lazy: true, middleware: false, method: "get" },
  { route: '/api/orders', handler: _lazy_qPuHZc, lazy: true, middleware: false, method: "post" },
  { route: '/api/products', handler: _lazy_UDkCEj, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_y3aAom, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _th4mdk, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _cuTWqx, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _jV639t, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug-production.json', handler: _k9w9bu, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _U19pTR, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _8gwhEF, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _LwPWF3, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _RPWm18, lazy: false, middleware: true, method: undefined },
  { route: '/__robots__/debug.json', handler: _AHeKSI, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _2FBAX3, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-production.json', handler: _ZK6vBL, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: __WInkx, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_y3aAom, lazy: true, middleware: false, method: undefined }
];
...
const sources$1 = [
    {
        ...
        "urls": [
            ...
            {
                "loc": "/services/montazh-svaj"
            },
            {
                "loc": "/services/fundament-pod-dom"
            },
            {
                "loc": "/services/fundament-pod-banju"
            }
        ],
        "sourceType": "app"
    }
...
const orders_get = defineEventHandler(() => {
...
const itemSchema = z.object({
  ...
  qty: z.number().int().min(1).max(1e4),
...
const orders_post = defineEventHandler(async (event) => {
  ...
  try {
    const config = useRuntimeConfig();
    const nodemailer = await import('file://D:/%D0%B2%D0%BC/project-03b78a3c/nuxt-svai/node_modules/nodemailer/lib/nodemailer.js');
...
function parseProductsCSV(csvContent) {
  const lines = csvContent.split("\n").filter((l) => l.trim());
  return lines.slice(1).map((line, idx) => {
    var _a;
    const values = line.split(",");
    const name = values[0] || "";
    const slug = name.toLowerCase().replace(/[^a-zа-яё0-9\s]/g, "").replace(/\s+/g, "-").replace(/[а-яё]/g, (c) => {
      const map = {
        \u0430: "a",
        \u0431: "b",
        \u0432: "v",
    ...
    return {
      ...
      category: ((_a = values[6]) == null ? void 0 : _a.trim()) || "\u0421\u0442\u0430\u043D\u0434\u0430\u0440\u0442",
      in_stock: true,
      image_url: "",
      description: ""
    };
